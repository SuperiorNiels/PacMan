...
public:
    ...
    RenderSystem(World* world, int screen_width, int screen_height, TimerSystem* timer)
    {
        ...
        RenderSystem::x_screen_offset = (int) floorf((RenderSystem::screen_width - RenderSystem::world_width) / 2.f);
        RenderSystem::y_screen_offset = (int) floorf((RenderSystem::screen_height - RenderSystem::world_height) / 2.f);
    };
